...
class SimulationMetadata(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.observables is not None and not isinstance(
            self.observables, SimulationObservables
        ):
        ...
        if self.trajectory is not None and not isinstance(
            self.trajectory, TrajectoryMetadata
        ):
        ...
        if self.potentials is not None and not isinstance(
            self.potentials, PotentialMetadata
        ):
            self.potentials = PotentialMetadata(**as_dict(self.potentials))

        if self.compute is not None and not isinstance(
            self.compute, ComputationalEnvironment
        ):
...
class FrictionCoefficientQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/FrictionCoefficientQuantity"
    ]
    class_class_curie: ClassVar[str] = (
        "biosim_schema:quantities/FrictionCoefficientQuantity"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.value_unit is not None and not isinstance(
            self.value_unit, FrictionCoefficientUnit
        ):
...
class MolarEnergyQuantity(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.value_unit is not None and not isinstance(
            self.value_unit, MolarEnergyUnit
        ):
...
class TemperatureQuantity(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.value_unit is not None and not isinstance(
            self.value_unit, TemperatureUnit
        ):
...
class ConcentrationQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/ConcentrationQuantity"
    ]
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.value_unit is not None and not isinstance(
            self.value_unit, ConcentrationUnit
        ):
...
class AngleQuantity(YAMLRoot):
    ...
    value: Optional[float] = None
    value_unit: Optional[Union[str, "AngleUnit"]] = "degrees"
...
class VectorLengthQuantity(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if not isinstance(self.vector_value, list):
            self.vector_value = (
                [self.vector_value] if self.vector_value is not None else []
            )
        self.vector_value = [
            v if isinstance(v, float) else float(v) for v in self.vector_value
        ]
...
class VectorCompressibilityQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/VectorCompressibilityQuantity"
    ]
    class_class_curie: ClassVar[str] = (
        "biosim_schema:quantities/VectorCompressibilityQuantity"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.value_unit is not None and not isinstance(
            self.value_unit, CompressibilityUnit
        ):
...
class VectorPressureQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/VectorPressureQuantity"
    ]
...
class VectorTemperatureQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/VectorTemperatureQuantity"
    ]
    class_class_curie: ClassVar[str] = (
        "biosim_schema:quantities/VectorTemperatureQuantity"
    )
...
class MatrixPressureQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/MatrixPressureQuantity"
    ]
...
class MatrixCompressibilityQuantity(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "quantities/MatrixCompressibilityQuantity"
    ]
    class_class_curie: ClassVar[str] = (
        "biosim_schema:quantities/MatrixCompressibilityQuantity"
    )
...
class SimulationStages(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.minimisation is not None and not isinstance(
            self.minimisation, Minimisation
        ):
            self.minimisation = Minimisation(**as_dict(self.minimisation))

        if self.equilibration is not None and not isinstance(
...
class Minimisation(YAMLRoot):
    ...
    minimisation_algorithm: Optional[
        Union[
            Union[str, "MinimisationAlgorithm"],
            list[Union[str, "MinimisationAlgorithm"]],
        ]
    ] = empty_list()
    simulation_tool: Optional[
        Union[Union[str, "SimulationTool"], list[Union[str, "SimulationTool"]]]
    ] = empty_list()
    simulation_software: Optional[
        Union[Union[str, "SimulationSoftware"], list[Union[str, "SimulationSoftware"]]]
    ] = empty_list()

    def __post_init__(self, *_: str, **kwargs: Any):
        if self.energy_tolerance is not None and not isinstance(
            self.energy_tolerance, ForceQuantity
        ):
            self.energy_tolerance = ForceQuantity(**as_dict(self.energy_tolerance))

        if self.number_of_minimisation_steps is not None and not isinstance(
            self.number_of_minimisation_steps, int
        ):
            self.number_of_minimisation_steps = int(self.number_of_minimisation_steps)

        if self.minimisation_distance_step_size is not None and not isinstance(
            self.minimisation_distance_step_size, LengthQuantity
        ):
            self.minimisation_distance_step_size = LengthQuantity(
                **as_dict(self.minimisation_distance_step_size)
            )

        if not isinstance(self.minimisation_algorithm, list):
            self.minimisation_algorithm = (
                [self.minimisation_algorithm]
                if self.minimisation_algorithm is not None
                else []
            )
        self.minimisation_algorithm = [
            v if isinstance(v, MinimisationAlgorithm) else MinimisationAlgorithm(v)
            for v in self.minimisation_algorithm
        ]

        if not isinstance(self.simulation_tool, list):
            self.simulation_tool = (
                [self.simulation_tool] if self.simulation_tool is not None else []
            )
        self.simulation_tool = [
            v if isinstance(v, SimulationTool) else SimulationTool(v)
            for v in self.simulation_tool
        ]

        if not isinstance(self.simulation_software, list):
            self.simulation_software = (
                [self.simulation_software]
                if self.simulation_software is not None
                else []
            )
        self.simulation_software = [
            v if isinstance(v, SimulationSoftware) else SimulationSoftware(v)
            for v in self.simulation_software
        ]
...
class Production(YAMLRoot):
    ...
    simulation_method: Optional[
        Union[Union[str, "SimulationMethod"], list[Union[str, "SimulationMethod"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.simulation_software_version is not None and not isinstance(
            self.simulation_software_version, str
        ):
        ...
        if not isinstance(self.simulation_method, list):
            self.simulation_method = (
                [self.simulation_method] if self.simulation_method is not None else []
            )
        self.simulation_method = [
            v if isinstance(v, SimulationMethod) else SimulationMethod(v)
            for v in self.simulation_method
        ]
...
class Analysis(YAMLRoot):
    ...
    analysis_tool: Optional[
        Union[Union[str, "AnalysisTool"], list[Union[str, "AnalysisTool"]]]
    ] = empty_list()
    analysis_software: Optional[
        Union[Union[str, "AnalysisSoftware"], list[Union[str, "AnalysisSoftware"]]]
    ] = empty_list()
    analysis_method: Optional[
        Union[Union[str, "AnalysisMethod"], list[Union[str, "AnalysisMethod"]]]
    ] = empty_list()

    def __post_init__(self, *_: str, **kwargs: Any):
        if not isinstance(self.analysis_tool, list):
            self.analysis_tool = (
                [self.analysis_tool] if self.analysis_tool is not None else []
            )
        self.analysis_tool = [
            v if isinstance(v, AnalysisTool) else AnalysisTool(v)
            for v in self.analysis_tool
        ]

        if not isinstance(self.analysis_software, list):
            self.analysis_software = (
                [self.analysis_software] if self.analysis_software is not None else []
            )
        self.analysis_software = [
            v if isinstance(v, AnalysisSoftware) else AnalysisSoftware(v)
            for v in self.analysis_software
        ]

        if not isinstance(self.analysis_method, list):
            self.analysis_method = (
                [self.analysis_method] if self.analysis_method is not None else []
            )
        self.analysis_method = [
            v if isinstance(v, AnalysisMethod) else AnalysisMethod(v)
            for v in self.analysis_method
        ]
...
class SimulationSettings(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.interactions is not None and not isinstance(
...
class Ensemble(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.ensemble_type is not None and not isinstance(
            self.ensemble_type, EnsembleType
        ):
...
class Interactions(YAMLRoot):
    ...
    bond_length_constraints_algorithm: Optional[
        Union[str, "BondLengthConstraintsAlgorithm"]
    ] = None
    long_range_interaction_method: Optional[
        Union[str, "LongRangeInteractionMethod"]
    ] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.electrostatic_cutoff_distance is not None and not isinstance(
            self.electrostatic_cutoff_distance, LengthQuantity
        ):
            self.electrostatic_cutoff_distance = LengthQuantity(
                **as_dict(self.electrostatic_cutoff_distance)
            )

        if self.vdw_cutoff_distance is not None and not isinstance(
            self.vdw_cutoff_distance, LengthQuantity
        ):
            self.vdw_cutoff_distance = LengthQuantity(
                **as_dict(self.vdw_cutoff_distance)
            )

        if self.bond_length_constraints_algorithm is not None and not isinstance(
            self.bond_length_constraints_algorithm, BondLengthConstraintsAlgorithm
        ):
            self.bond_length_constraints_algorithm = BondLengthConstraintsAlgorithm(
                self.bond_length_constraints_algorithm
            )

        if self.long_range_interaction_method is not None and not isinstance(
            self.long_range_interaction_method, LongRangeInteractionMethod
        ):
            self.long_range_interaction_method = LongRangeInteractionMethod(
                self.long_range_interaction_method
            )
...
class Integrator(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.integrator_algorithm is not None and not isinstance(
            self.integrator_algorithm, IntegratorAlgorithm
        ):
            self.integrator_algorithm = IntegratorAlgorithm(self.integrator_algorithm)

        if self.frame_step is not None and not isinstance(
            self.frame_step, TimeQuantity
        ):
        ...
        if self.number_of_steps is not None and not isinstance(
            self.number_of_steps, int
        ):
            self.number_of_steps = int(self.number_of_steps)

        if self.simulation_time is not None and not isinstance(
            self.simulation_time, TimeQuantity
        ):
...
class Barostat(YAMLRoot):
    ...
    compressibility: Optional[Union[dict, MatrixCompressibilityQuantity]] = None
    target_pressure: Optional[Union[dict, MatrixPressureQuantity]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.barostat_algorithm is not None and not isinstance(
            self.barostat_algorithm, BarostatAlgorithm
        ):
            self.barostat_algorithm = BarostatAlgorithm(self.barostat_algorithm)

        if self.compressibility is not None and not isinstance(
            self.compressibility, MatrixCompressibilityQuantity
        ):
            self.compressibility = MatrixCompressibilityQuantity(
                **as_dict(self.compressibility)
            )

        if self.target_pressure is not None and not isinstance(
            self.target_pressure, MatrixPressureQuantity
        ):
            self.target_pressure = MatrixPressureQuantity(
                **as_dict(self.target_pressure)
            )

        if self.pressure_time_constant is not None and not isinstance(
            self.pressure_time_constant, TimeQuantity
        ):
            self.pressure_time_constant = TimeQuantity(
                **as_dict(self.pressure_time_constant)
            )

        if self.pressure_coupling_frequency is not None and not isinstance(
            self.pressure_coupling_frequency, int
        ):
            self.pressure_coupling_frequency = int(self.pressure_coupling_frequency)

        if self.pressure_coupling_type is not None and not isinstance(
            self.pressure_coupling_type, PressureCouplingType
        ):
            self.pressure_coupling_type = PressureCouplingType(
                self.pressure_coupling_type
            )
...
class Thermostat(YAMLRoot):
    ...
    target_temperature: Optional[Union[dict, VectorTemperatureQuantity]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.thermostat_algorithm is not None and not isinstance(
            self.thermostat_algorithm, ThermostatAlgorithm
        ):
        ...
        if self.target_temperature is not None and not isinstance(
            self.target_temperature, VectorTemperatureQuantity
        ):
            self.target_temperature = VectorTemperatureQuantity(
                **as_dict(self.target_temperature)
            )

        if self.collision_frequency is not None and not isinstance(
            self.collision_frequency, FrequencyQuantity
        ):
            self.collision_frequency = FrequencyQuantity(
                **as_dict(self.collision_frequency)
            )

        if self.temperature_time_constant is not None and not isinstance(
            self.temperature_time_constant, VectorTimeQuantity
        ):
            self.temperature_time_constant = VectorTimeQuantity(
                **as_dict(self.temperature_time_constant)
            )
        ...
        if self.friction_coefficient is not None and not isinstance(
            self.friction_coefficient, FrictionCoefficientQuantity
        ):
            self.friction_coefficient = FrictionCoefficientQuantity(
                **as_dict(self.friction_coefficient)
            )
...
class SystemComposition(YAMLRoot):
    ...
    molecule_ID: Optional[
        Union[Union[dict, "MoleculeID"], list[Union[dict, "MoleculeID"]]]
    ] = empty_list()

    def __post_init__(self, *_: str, **kwargs: Any):
        if self.system_counts is not None and not isinstance(
            self.system_counts, SystemCounts
        ):
            self.system_counts = SystemCounts(**as_dict(self.system_counts))

        if not isinstance(self.molecule_ID, list):
            self.molecule_ID = (
                [self.molecule_ID] if self.molecule_ID is not None else []
            )
        self.molecule_ID = [
            v if isinstance(v, MoleculeID) else MoleculeID(**as_dict(v))
            for v in self.molecule_ID
        ]
...
class SystemCounts(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.total_molecule_count is not None and not isinstance(
            self.total_molecule_count, int
        ):
            self.total_molecule_count = int(self.total_molecule_count)

        if self.total_atom_count is not None and not isinstance(
            self.total_atom_count, int
        ):
            self.total_atom_count = int(self.total_atom_count)

        if self.unique_molecule_count is not None and not isinstance(
            self.unique_molecule_count, int
        ):
            self.unique_molecule_count = int(self.unique_molecule_count)

        if self.salt_concentration is not None and not isinstance(
            self.salt_concentration, ConcentrationQuantity
        ):
            self.salt_concentration = ConcentrationQuantity(
                **as_dict(self.salt_concentration)
            )
...
class MoleculeID(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.protein_sequence is not None and not isinstance(
            self.protein_sequence, str
        ):
            self.protein_sequence = str(self.protein_sequence)

        if self.nucleic_sequence is not None and not isinstance(
            self.nucleic_sequence, str
        ):
            self.nucleic_sequence = str(self.nucleic_sequence)

        if self.predicted_structure is not None and not isinstance(
            self.predicted_structure, Bool
        ):
        ...
        if self.molecular_formula is not None and not isinstance(
            self.molecular_formula, str
        ):
            self.molecular_formula = str(self.molecular_formula)

        if self.molecular_weight is not None and not isinstance(
            self.molecular_weight, MassQuantity
        ):
            self.molecular_weight = MassQuantity(**as_dict(self.molecular_weight))

        if self.molecule_charge is not None and not isinstance(
            self.molecule_charge, ChargeQuantity
        ):
...
class SimulationObservables(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.simulation_averages is not None and not isinstance(
            self.simulation_averages, SimulationAverages
        ):
            self.simulation_averages = SimulationAverages(
                **as_dict(self.simulation_averages)
            )
...
class SimulationAverages(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.average_kinetic_energy is not None and not isinstance(
            self.average_kinetic_energy, MolarEnergyQuantity
        ):
            self.average_kinetic_energy = MolarEnergyQuantity(
                **as_dict(self.average_kinetic_energy)
            )

        if self.average_potential_energy is not None and not isinstance(
            self.average_potential_energy, MolarEnergyQuantity
        ):
            self.average_potential_energy = MolarEnergyQuantity(
                **as_dict(self.average_potential_energy)
            )

        if self.average_enthalpy is not None and not isinstance(
            self.average_enthalpy, MolarEnergyQuantity
        ):
            self.average_enthalpy = MolarEnergyQuantity(
                **as_dict(self.average_enthalpy)
            )

        if self.average_pressure is not None and not isinstance(
            self.average_pressure, PressureQuantity
        ):
            self.average_pressure = PressureQuantity(**as_dict(self.average_pressure))

        if self.average_temperature is not None and not isinstance(
            self.average_temperature, TemperatureQuantity
        ):
            self.average_temperature = TemperatureQuantity(
                **as_dict(self.average_temperature)
            )

        if self.average_volume is not None and not isinstance(
            self.average_volume, VolumeQuantity
        ):
            self.average_volume = VolumeQuantity(**as_dict(self.average_volume))

        if self.average_volume_vector is not None and not isinstance(
            self.average_volume_vector, VectorVolumeQuantity
        ):
            self.average_volume_vector = VectorVolumeQuantity(
                **as_dict(self.average_volume_vector)
            )
...
class TopologyMetadata(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.connectivity is not None and not isinstance(
...
class Particles(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.system_charge is not None and not isinstance(
            self.system_charge, ChargeQuantity
        ):
            self.system_charge = ChargeQuantity(**as_dict(self.system_charge))

        if self.coarse_grained is not None and not isinstance(
            self.coarse_grained, Bool
        ):
            self.coarse_grained = Bool(self.coarse_grained)

        if self.resolution is not None and not isinstance(
            self.resolution, ModelResolution
        ):
...
class TrajectoryMetadata(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.simulation_box is not None and not isinstance(
            self.simulation_box, SimulationBox
        ):
            self.simulation_box = SimulationBox(**as_dict(self.simulation_box))

        if self.trajectory_output is not None and not isinstance(
            self.trajectory_output, Trajectories
        ):
...
class SimulationBox(YAMLRoot):
    ...
    periodic_boundary_conditions: Optional[Union[str, "PeriodicBoundaryConditions"]] = (
        None
    )

    def __post_init__(self, *_: str, **kwargs: Any):
        if self.box_dimensions is not None and not isinstance(
            self.box_dimensions, VectorLengthQuantity
        ):
            self.box_dimensions = VectorLengthQuantity(**as_dict(self.box_dimensions))

        if self.box_angles is not None and not isinstance(
            self.box_angles, VectorAngleQuantity
        ):
        ...
        if self.periodic_boundary_conditions is not None and not isinstance(
            self.periodic_boundary_conditions, PeriodicBoundaryConditions
        ):
            self.periodic_boundary_conditions = PeriodicBoundaryConditions(
...
class Trajectories(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.polarizable_charges is not None and not isinstance(
            self.polarizable_charges, Bool
        ):
...
class PotentialMetadata(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.water_potential is not None and not isinstance(
            self.water_potential, WaterPotential
        ):
            self.water_potential = WaterPotential(**as_dict(self.water_potential))

        if self.protein_potential is not None and not isinstance(
            self.protein_potential, ProteinPotential
        ):
            self.protein_potential = ProteinPotential(**as_dict(self.protein_potential))

        if self.lipid_potential is not None and not isinstance(
            self.lipid_potential, LipidPotential
        ):
            self.lipid_potential = LipidPotential(**as_dict(self.lipid_potential))

        if self.nucleic_potential is not None and not isinstance(
            self.nucleic_potential, NucleicPotential
        ):
            self.nucleic_potential = NucleicPotential(**as_dict(self.nucleic_potential))

        if self.carbohydrate_potential is not None and not isinstance(
            self.carbohydrate_potential, CarbohydratePotential
        ):
            self.carbohydrate_potential = CarbohydratePotential(
                **as_dict(self.carbohydrate_potential)
            )

        if self.polymer_potential is not None and not isinstance(
            self.polymer_potential, PolymerPotential
        ):
            self.polymer_potential = PolymerPotential(**as_dict(self.polymer_potential))

        if self.general_potential is not None and not isinstance(
            self.general_potential, GeneralPotential
        ):
            self.general_potential = GeneralPotential(**as_dict(self.general_potential))

        if self.machine_learned_potential is not None and not isinstance(
            self.machine_learned_potential, MachineLearnedPotential
        ):
            self.machine_learned_potential = MachineLearnedPotential(
                **as_dict(self.machine_learned_potential)
            )
...
class WaterPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.water_potential_name is not None and not isinstance(
            self.water_potential_name, WaterPotentialName
        ):
...
class ProteinPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.protein_potential_name is not None and not isinstance(
            self.protein_potential_name, ProteinPotentialName
        ):
            self.protein_potential_name = ProteinPotentialName(
                self.protein_potential_name
            )
...
class LipidPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.lipid_potential_name is not None and not isinstance(
            self.lipid_potential_name, LipidPotentialName
        ):
...
class NucleicPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.nucleic_potential_name is not None and not isinstance(
            self.nucleic_potential_name, NucleicPotentialName
        ):
            self.nucleic_potential_name = NucleicPotentialName(
                self.nucleic_potential_name
            )
...
class CarbohydratePotential(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "potentials/CarbohydratePotential"
    ]
    ...
    carbohydrate_potential_name: Optional[Union[str, "CarbohydratePotentialName"]] = (
        None
    )
    modified: Optional[Union[bool, Bool]] = None

    def __post_init__(self, *_: str, **kwargs: Any):
        if self.carbohydrate_potential_name is not None and not isinstance(
            self.carbohydrate_potential_name, CarbohydratePotentialName
        ):
            self.carbohydrate_potential_name = CarbohydratePotentialName(
                self.carbohydrate_potential_name
            )
...
class PolymerPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.polymer_potential_name is not None and not isinstance(
            self.polymer_potential_name, PolymerPotentialName
        ):
            self.polymer_potential_name = PolymerPotentialName(
                self.polymer_potential_name
            )
...
class GeneralPotential(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.general_potential_name is not None and not isinstance(
            self.general_potential_name, GeneralPotentialName
        ):
            self.general_potential_name = GeneralPotentialName(
                self.general_potential_name
            )
...
class MachineLearnedPotential(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "potentials/MachineLearnedPotential"
    ]
    class_class_curie: ClassVar[str] = (
        "biosim_schema:potentials/MachineLearnedPotential"
    )
    class_name: ClassVar[str] = "MachineLearnedPotential"
    class_model_uri: ClassVar[URIRef] = BIOSIM_SCHEMA.MachineLearnedPotential

    machine_learned_potential_name: Optional[
        Union[str, "MachineLearnedPotentialName"]
    ] = None
    modified: Optional[Union[bool, Bool]] = None

    def __post_init__(self, *_: str, **kwargs: Any):
        if self.machine_learned_potential_name is not None and not isinstance(
            self.machine_learned_potential_name, MachineLearnedPotentialName
        ):
            self.machine_learned_potential_name = MachineLearnedPotentialName(
                self.machine_learned_potential_name
            )
...
class ComputationalEnvironment(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = BIOSIM_SCHEMA[
        "compute/ComputationalEnvironment"
    ]
...
class Hardware(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.execution_platform is not None and not isinstance(
            self.execution_platform, ExecutionPlatform
        ):
        ...
        if self.CPU_architecture is not None and not isinstance(
            self.CPU_architecture, CpuArchitecture
        ):
            self.CPU_architecture = CpuArchitecture(self.CPU_architecture)

        if self.sockets_per_node is not None and not isinstance(
            self.sockets_per_node, int
        ):
            self.sockets_per_node = int(self.sockets_per_node)

        if self.cores_per_socket is not None and not isinstance(
            self.cores_per_socket, int
        ):
            self.cores_per_socket = int(self.cores_per_socket)

        if self.threads_per_core is not None and not isinstance(
        ...
        if self.memory_per_node is not None and not isinstance(
            self.memory_per_node, ByteQuantity
        ):
...
class Software(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.operating_system is not None and not isinstance(
        ...
        if self.MPI_library is not None and not isinstance(
            self.MPI_library, MPILibrary
        ):
            self.MPI_library = MPILibrary(self.MPI_library)

        if self.container_runtime is not None and not isinstance(
...
class Performance(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.energy_consumption is not None and not isinstance(
            self.energy_consumption, EnergyQuantity
        ):
...
class LengthUnit(EnumDefinitionImpl):
    Å = PermissibleValue(
        text="Å", description="Length units in Angstrom.", meaning=QUDT["ANGSTROM"]
    )
    nm = PermissibleValue(
        text="nm", description="Length units in nanometers.", meaning=QUDT["NanoM"]
    )
...
class VolumeUnit(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        ...
        setattr(
            cls,
            "nm³",
            PermissibleValue(text="nm³", description="Volume units in nanometer^3."),
        )


class ConcentrationUnit(EnumDefinitionImpl):
    M = PermissibleValue(text="M", meaning=QUDT["MOL-PER-M3"])
...
class TimeUnit(EnumDefinitionImpl):
    ...
    s = PermissibleValue(
        text="s", description="Time units in seconds.", meaning=QUDT["SEC"]
    )
    ms = PermissibleValue(
        text="ms", description="Time units in milliseconds.", meaning=QUDT["MilliSEC"]
    )
    μs = PermissibleValue(
        text="μs", description="Time units in microseconds.", meaning=QUDT["MicroSEC"]
    )
    ns = PermissibleValue(
        text="ns", description="Time units in nanoseconds.", meaning=QUDT["NanoSEC"]
    )
    ps = PermissibleValue(
        text="ps", description="Time units in picoseconds.", meaning=QUDT["PicoSEC"]
    )
    fs = PermissibleValue(text="fs", description="Time units in femtoseconds.")
...
class FrequencyUnit(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            ...
            "1/ps",
            PermissibleValue(
                text="1/ps", description="Frequncy units in reciprocal picoseconds."
            ),
        )
...
class FrictionCoefficientUnit(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "a/ps", PermissibleValue(text="a/ps"))
        setattr(cls, "kg/s", PermissibleValue(text="kg/s"))
...
class TemperatureUnit(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "°C", PermissibleValue(text="°C"))
        setattr(cls, "°F", PermissibleValue(text="°F"))


class PressureUnit(EnumDefinitionImpl):
    bar = PermissibleValue(text="bar")
...
class CompressibilityUnit(EnumDefinitionImpl):
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "1/bar", PermissibleValue(text="1/bar", meaning=QUDT["PER-BAR"]))
        setattr(cls, "1/Pa", PermissibleValue(text="1/Pa", meaning=QUDT["PER-PA"]))
...
class AngleUnit(EnumDefinitionImpl):
    ...
    degrees = PermissibleValue(text="degrees", description="Angle units in degree.")
...
class MolarEnergyUnit(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            ...
            "kcal/mol",
            PermissibleValue(
                text="kcal/mol", description="kcal/mol", meaning=QUDT["KiloCAL-PER-MOL"]
            ),
        )
        setattr(
            cls,
            "kJ/mol",
            PermissibleValue(
                text="kJ/mol", description="kJ/mol", meaning=QUDT["KiloJ-PER-MOL"]
            ),
        )
...
class EnergyUnit(EnumDefinitionImpl):
    ...
    kWh = PermissibleValue(
        text="kWh", description="kilowatt-hour", meaning=QUDT["KiloW-HR"]
    )
...
class MassUnit(EnumDefinitionImpl):
    ...
    Da = PermissibleValue(text="Da", description="daltons", meaning=QUDT["Dalton"])
    ...
    def _addvals(cls):
        setattr(
            ...
            "g/mol",
            PermissibleValue(
                text="g/mol", description="grams per mole", meaning=QUDT["GramPerMole"]
            ),
        )
...
class SetupTool(EnumDefinitionImpl):
    ...
    packmol = PermissibleValue(text="packmol")
...
class AnalysisTool(EnumDefinitionImpl):
    ...
    PYTRAJ = PermissibleValue(
        text="PYTRAJ", description="The Python front end of cpptraj."
    )
    ...
    PLUMED = PermissibleValue(text="PLUMED")
    MDanalysis = PermissibleValue(text="MDanalysis")
...
class AnalysisSoftware(EnumDefinitionImpl):
    ...
    VMD = PermissibleValue(text="VMD")
    PyMOL = PermissibleValue(text="PyMOL")
    Avogadro = PermissibleValue(text="Avogadro")
    ...
    def _addvals(cls):
        setattr(
            cls, "Schrodinger Maestro", PermissibleValue(text="Schrodinger Maestro")
        )
...
class LongRangeInteractionMethod(EnumDefinitionImpl):
    ...
    Cutoff = PermissibleValue(
        text="Cutoff", description="Plain cut-off used to implement electrostatics."
    )
...
class PeriodicBoundaryConditions(EnumDefinitionImpl):
    ...
    xyz = PermissibleValue(text="xyz", description="all axes")
    xy = PermissibleValue(text="xy", description="only xy plane")
    xz = PermissibleValue(text="xz", description="only xz plane")
    yz = PermissibleValue(text="yz", description="only yz plane")
    ...
    @classmethod
    def _addvals(cls):
        setattr(cls, "None", PermissibleValue(text="None", description="No PBC"))
...
class BoxType(EnumDefinitionImpl):
    ...
    Cubic = PermissibleValue(text="Cubic")
    Tetragonal = PermissibleValue(text="Tetragonal")
    Orthorhombic = PermissibleValue(text="Orthorhombic")
    Triclinic = PermissibleValue(text="Triclinic")
    ...
    def _addvals(cls):
        setattr(
            cls, "Truncated Octahedron", PermissibleValue(text="Truncated Octahedron")
        )
...
class WaterPotentialName(EnumDefinitionImpl):
    ...
    POL3 = PermissibleValue(text="POL3", description="Parameters for a water model.")
    TIP3P = PermissibleValue(
        text="TIP3P",
        description="Parameters for the force balance 3-point water model.",
    )
    TIP3PFB = PermissibleValue(
        text="TIP3PFB", description="Parameters for a water model."
    )
    TIP4PFB = PermissibleValue(
        text="TIP4PFB", description="Parameters for a water model."
    )
    TIP4P = PermissibleValue(text="TIP4P", description="Parameters for a water model.")
    TIP5P = PermissibleValue(text="TIP5P", description="Parameters for a water model.")
    TIP4PEW = PermissibleValue(
        text="TIP4PEW", description="Parameters for a water model."
    )
    SPCE = PermissibleValue(text="SPCE", description="Parameters for a water model.")
    SPCEB = PermissibleValue(text="SPCEB", description="Parameters for a water model.")
...
class ProteinPotentialName(EnumDefinitionImpl):
    ...
    phosaa10 = PermissibleValue(
        text="phosaa10", description="Force field for phosphorylated amino acids."
    )
...
class NucleicPotentialName(EnumDefinitionImpl):
    ...
    Shaw = PermissibleValue(
        text="Shaw", description="RNA force field with more extensive modifications."
    )
    ...
    OL24 = PermissibleValue(text="OL24")
    OL3 = PermissibleValue(text="OL3")
    ...
    terminal_monophosphate = PermissibleValue(
        ...
        description=r"""Force field library for the 5\’ end of many DNA and RNA chains have one or more phosphate groups.""",
    )
...
class Scheduler(EnumDefinitionImpl):
    ...
    SLURM = PermissibleValue(text="SLURM", description="Slurm Workload Manager.")
    PBS = PermissibleValue(
        text="PBS", description="Portable Batch System family (PBS Pro/OpenPBS)."
    )
    LSF = PermissibleValue(text="LSF", description="IBM Spectrum LSF.")
    SGE = PermissibleValue(text="SGE", description="Sun/Grid Engine family.")
    ...
    def _addvals(cls):
        setattr(
            cls,
            "None",
            PermissibleValue(text="None", description="No batch scheduler used."),
        )
...
class MPILibrary(EnumDefinitionImpl):
    ...
    OpenMPI = PermissibleValue(
        text="OpenMPI", description="Open source MPI implementation."
    )
    MPICH = PermissibleValue(text="MPICH", description="MPICH MPI implementation.")
    IntelMPI = PermissibleValue(
        text="IntelMPI", description="Intel MPI implementation."
    )
    MVAPICH2 = PermissibleValue(
        text="MVAPICH2", description="MVAPICH2 MPI implementation."
    )
    ...
    def _addvals(cls):
        setattr(
            cls,
            "None",
            PermissibleValue(text="None", description="No MPI library used."),
        )
...
class ContainerRuntime(EnumDefinitionImpl):
    ...
    Docker = PermissibleValue(text="Docker", description="Docker container runtime.")
    Podman = PermissibleValue(text="Podman", description="Podman container runtime.")
    ...
    def _addvals(cls):
        setattr(
            cls,
            "None",
            PermissibleValue(text="None", description="No container runtime used."),
        )
...
class ExecutionPlatform(EnumDefinitionImpl):
    ...
    Local = PermissibleValue(
        text="Local", description="Local desktop, laptop or portable workstation."
    )
    ...
    def _addvals(cls):
        ...
        setattr(
            ...
            "Cloud VM",
            PermissibleValue(
                text="Cloud VM", description="Cloud-hosted virtual machine."
            ),
        )
...
class NodeType(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            cls,
            "CPU only",
            PermissibleValue(text="CPU only", description="Node with CPUs only."),
        )
        setattr(
            cls,
            "GPU Accelerated",
...
class CpuVendor(EnumDefinitionImpl):
    ...
    AMD = PermissibleValue(text="AMD", description="AMD processor.")
    Intel = PermissibleValue(text="Intel", description="Intel processor.")
    ARM = PermissibleValue(text="ARM", description="ARM-based processor.")
    Other = PermissibleValue(text="Other", description="Other CPU vendor.")
...
class CpuArchitecture(EnumDefinitionImpl):
    ...
    x86 = PermissibleValue(text="x86", description="x86 architecture.")
    ARM = PermissibleValue(text="ARM", description="ARM architecture.")
...
class GpuVendor(EnumDefinitionImpl):
    ...
    Nvidia = PermissibleValue(text="Nvidia", description="Nvidia GPU.")
    AMD = PermissibleValue(text="AMD", description="AMD GPU.")
    Intel = PermissibleValue(text="Intel", description="Intel GPU.")
    ...
    def _addvals(cls):
        setattr(
            cls, "None", PermissibleValue(text="None", description="No GPU present.")
        )
...
slots.stages = Slot(
    uri=BIOSIM_SCHEMA.stages,
    name="stages",
    curie=BIOSIM_SCHEMA.curie("stages"),
    model_uri=BIOSIM_SCHEMA.stages,
    domain=None,
    range=Optional[Union[dict, SimulationStages]],
)

slots.settings = Slot(
    uri=BIOSIM_SCHEMA.settings,
    name="settings",
    curie=BIOSIM_SCHEMA.curie("settings"),
    model_uri=BIOSIM_SCHEMA.settings,
    domain=None,
    range=Optional[Union[dict, SimulationSettings]],
)

slots.composition = Slot(
    uri=BIOSIM_SCHEMA.composition,
    name="composition",
    curie=BIOSIM_SCHEMA.curie("composition"),
    model_uri=BIOSIM_SCHEMA.composition,
    domain=None,
    range=Optional[Union[dict, SystemComposition]],
)

slots.observables = Slot(
    uri=BIOSIM_SCHEMA.observables,
    name="observables",
    curie=BIOSIM_SCHEMA.curie("observables"),
    model_uri=BIOSIM_SCHEMA.observables,
    domain=None,
    range=Optional[Union[dict, SimulationObservables]],
)

slots.topology = Slot(
    uri=BIOSIM_SCHEMA.topology,
    name="topology",
    curie=BIOSIM_SCHEMA.curie("topology"),
    model_uri=BIOSIM_SCHEMA.topology,
    domain=None,
    range=Optional[Union[dict, TopologyMetadata]],
)

slots.trajectory = Slot(
    uri=BIOSIM_SCHEMA.trajectory,
    name="trajectory",
    curie=BIOSIM_SCHEMA.curie("trajectory"),
    model_uri=BIOSIM_SCHEMA.trajectory,
    domain=None,
    range=Optional[Union[dict, TrajectoryMetadata]],
)

slots.potentials = Slot(
    uri=BIOSIM_SCHEMA.potentials,
    name="potentials",
    curie=BIOSIM_SCHEMA.curie("potentials"),
    model_uri=BIOSIM_SCHEMA.potentials,
    domain=None,
    range=Optional[Union[dict, PotentialMetadata]],
)

slots.compute = Slot(
    uri=BIOSIM_SCHEMA.compute,
    name="compute",
    curie=BIOSIM_SCHEMA.curie("compute"),
    model_uri=BIOSIM_SCHEMA.compute,
    domain=None,
    range=Optional[Union[dict, ComputationalEnvironment]],
)

slots.engine_mapping = Slot(
    uri=BIOSIM_SCHEMA.engine_mapping,
    name="engine_mapping",
    curie=BIOSIM_SCHEMA.curie("engine_mapping"),
    model_uri=BIOSIM_SCHEMA.engine_mapping,
    domain=None,
    range=Optional[Union[str, list[str]]],
)

slots.value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.value,
    domain=None,
    range=Optional[float],
)

slots.value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.value_unit,
    domain=None,
    range=Optional[str],
)

slots.vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vector_value,
    domain=None,
    range=Optional[str],
)

slots.setup = Slot(
    uri=BIOSIM_SCHEMA["stages/setup"],
    name="setup",
    curie=BIOSIM_SCHEMA.curie("stages/setup"),
    model_uri=BIOSIM_SCHEMA.setup,
    domain=None,
    range=Optional[Union[dict, Setup]],
)

slots.minimisation = Slot(
    uri=BIOSIM_SCHEMA["stages/minimisation"],
    name="minimisation",
    curie=BIOSIM_SCHEMA.curie("stages/minimisation"),
    model_uri=BIOSIM_SCHEMA.minimisation,
    domain=None,
    range=Optional[Union[dict, Minimisation]],
)

slots.number_of_minimisation_steps = Slot(
    uri=BIOSIM_SCHEMA["stages/number_of_minimisation_steps"],
    name="number_of_minimisation_steps",
    curie=BIOSIM_SCHEMA.curie("stages/number_of_minimisation_steps"),
    model_uri=BIOSIM_SCHEMA.number_of_minimisation_steps,
    domain=None,
    range=Optional[int],
)

slots.equilibration = Slot(
    uri=BIOSIM_SCHEMA["stages/equilibration"],
    name="equilibration",
    curie=BIOSIM_SCHEMA.curie("stages/equilibration"),
    model_uri=BIOSIM_SCHEMA.equilibration,
    domain=None,
    range=Optional[Union[dict, Equilibration]],
)

slots.production = Slot(
    uri=BIOSIM_SCHEMA["stages/production"],
    name="production",
    curie=BIOSIM_SCHEMA.curie("stages/production"),
    model_uri=BIOSIM_SCHEMA.production,
    domain=None,
    range=Optional[Union[dict, Production]],
)

slots.analysis = Slot(
    uri=BIOSIM_SCHEMA["stages/analysis"],
    name="analysis",
    curie=BIOSIM_SCHEMA.curie("stages/analysis"),
    model_uri=BIOSIM_SCHEMA.analysis,
    domain=None,
    range=Optional[Union[dict, Analysis]],
)

slots.setup_tool = Slot(
    uri=BIOSIM_SCHEMA["stages/setup_tool"],
    name="setup_tool",
    curie=BIOSIM_SCHEMA.curie("stages/setup_tool"),
    model_uri=BIOSIM_SCHEMA.setup_tool,
    domain=None,
    range=Optional[Union[str, "SetupTool"]],
)

slots.energy_tolerance = Slot(
    uri=BIOSIM_SCHEMA["stages/energy_tolerance"],
    name="energy_tolerance",
    curie=BIOSIM_SCHEMA.curie("stages/energy_tolerance"),
    model_uri=BIOSIM_SCHEMA.energy_tolerance,
    domain=None,
    range=Optional[Union[dict, ForceQuantity]],
)

slots.minimisation_distance_step_size = Slot(
    uri=BIOSIM_SCHEMA["stages/minimisation_distance_step_size"],
    name="minimisation_distance_step_size",
    curie=BIOSIM_SCHEMA.curie("stages/minimisation_distance_step_size"),
    model_uri=BIOSIM_SCHEMA.minimisation_distance_step_size,
    domain=None,
    range=Optional[Union[dict, LengthQuantity]],
)

slots.minimisation_algorithm = Slot(
    uri=BIOSIM_SCHEMA["stages/minimisation_algorithm"],
    name="minimisation_algorithm",
    curie=BIOSIM_SCHEMA.curie("stages/minimisation_algorithm"),
    model_uri=BIOSIM_SCHEMA.minimisation_algorithm,
    domain=None,
    range=Optional[
        Union[
            Union[str, "MinimisationAlgorithm"],
...
slots.simulation_software = Slot(
    uri=BIOSIM_SCHEMA["stages/simulation_software"],
    name="simulation_software",
    curie=BIOSIM_SCHEMA.curie("stages/simulation_software"),
    model_uri=BIOSIM_SCHEMA.simulation_software,
    domain=None,
    range=Optional[
        Union[Union[str, "SimulationSoftware"], list[Union[str, "SimulationSoftware"]]]
    ],
...
slots.simulation_software_version = Slot(
    uri=BIOSIM_SCHEMA["stages/simulation_software_version"],
    name="simulation_software_version",
    curie=BIOSIM_SCHEMA.curie("stages/simulation_software_version"),
    model_uri=BIOSIM_SCHEMA.simulation_software_version,
    domain=None,
    range=Optional[str],
)

slots.simulation_method = Slot(
    uri=BIOSIM_SCHEMA["stages/simulation_method"],
    name="simulation_method",
    curie=BIOSIM_SCHEMA.curie("stages/simulation_method"),
    model_uri=BIOSIM_SCHEMA.simulation_method,
    domain=None,
    range=Optional[
        Union[Union[str, "SimulationMethod"], list[Union[str, "SimulationMethod"]]]
    ],
...
slots.simulation_tool = Slot(
    uri=BIOSIM_SCHEMA["stages/simulation_tool"],
    name="simulation_tool",
    curie=BIOSIM_SCHEMA.curie("stages/simulation_tool"),
    model_uri=BIOSIM_SCHEMA.simulation_tool,
    domain=None,
    range=Optional[
        Union[Union[str, "SimulationTool"], list[Union[str, "SimulationTool"]]]
    ],
...
slots.analysis_software = Slot(
    uri=BIOSIM_SCHEMA["stages/analysis_software"],
    name="analysis_software",
    curie=BIOSIM_SCHEMA.curie("stages/analysis_software"),
    model_uri=BIOSIM_SCHEMA.analysis_software,
    domain=None,
    range=Optional[
        Union[Union[str, "AnalysisSoftware"], list[Union[str, "AnalysisSoftware"]]]
    ],
...
slots.analysis_method = Slot(
    uri=BIOSIM_SCHEMA["stages/analysis_method"],
    name="analysis_method",
    curie=BIOSIM_SCHEMA.curie("stages/analysis_method"),
    model_uri=BIOSIM_SCHEMA.analysis_method,
    domain=None,
    range=Optional[
        Union[Union[str, "AnalysisMethod"], list[Union[str, "AnalysisMethod"]]]
    ],
...
slots.analysis_tool = Slot(
    uri=BIOSIM_SCHEMA["stages/analysis_tool"],
    name="analysis_tool",
    curie=BIOSIM_SCHEMA.curie("stages/analysis_tool"),
    model_uri=BIOSIM_SCHEMA.analysis_tool,
    domain=None,
    range=Optional[Union[Union[str, "AnalysisTool"], list[Union[str, "AnalysisTool"]]]],
)

slots.ensemble = Slot(
    uri=BIOSIM_SCHEMA["settings/ensemble"],
    name="ensemble",
    curie=BIOSIM_SCHEMA.curie("settings/ensemble"),
    model_uri=BIOSIM_SCHEMA.ensemble,
    domain=None,
    range=Optional[Union[dict, Ensemble]],
)

slots.interactions = Slot(
    uri=BIOSIM_SCHEMA["settings/interactions"],
    name="interactions",
    curie=BIOSIM_SCHEMA.curie("settings/interactions"),
    model_uri=BIOSIM_SCHEMA.interactions,
    domain=None,
    range=Optional[Union[dict, Interactions]],
)

slots.integrator = Slot(
    uri=BIOSIM_SCHEMA["settings/integrator"],
    name="integrator",
    curie=BIOSIM_SCHEMA.curie("settings/integrator"),
    model_uri=BIOSIM_SCHEMA.integrator,
    domain=None,
    range=Optional[Union[dict, Integrator]],
)

slots.barostat = Slot(
    uri=BIOSIM_SCHEMA["settings/barostat"],
    name="barostat",
    curie=BIOSIM_SCHEMA.curie("settings/barostat"),
    model_uri=BIOSIM_SCHEMA.barostat,
    domain=None,
    range=Optional[Union[dict, Barostat]],
)

slots.thermostat = Slot(
    uri=BIOSIM_SCHEMA["settings/thermostat"],
    name="thermostat",
    curie=BIOSIM_SCHEMA.curie("settings/thermostat"),
    model_uri=BIOSIM_SCHEMA.thermostat,
    domain=None,
    range=Optional[Union[dict, Thermostat]],
)

slots.time_step = Slot(
    uri=BIOSIM_SCHEMA["settings/time_step"],
    name="time_step",
    curie=BIOSIM_SCHEMA.curie("settings/time_step"),
    model_uri=BIOSIM_SCHEMA.time_step,
    domain=None,
    range=Optional[Union[dict, TimeQuantity]],
)

slots.frame_step = Slot(
    uri=BIOSIM_SCHEMA["settings/frame_step"],
    name="frame_step",
    curie=BIOSIM_SCHEMA.curie("settings/frame_step"),
    model_uri=BIOSIM_SCHEMA.frame_step,
    domain=None,
    range=Optional[Union[dict, TimeQuantity]],
)

slots.number_of_steps = Slot(
    uri=BIOSIM_SCHEMA["settings/number_of_steps"],
    name="number_of_steps",
    curie=BIOSIM_SCHEMA.curie("settings/number_of_steps"),
    model_uri=BIOSIM_SCHEMA.number_of_steps,
    domain=None,
    range=Optional[int],
)

slots.simulation_time = Slot(
    uri=BIOSIM_SCHEMA["settings/simulation_time"],
    name="simulation_time",
    curie=BIOSIM_SCHEMA.curie("settings/simulation_time"),
    model_uri=BIOSIM_SCHEMA.simulation_time,
    domain=None,
    range=Optional[Union[dict, TimeQuantity]],
)

slots.restraints = Slot(
    uri=BIOSIM_SCHEMA["settings/restraints"],
    name="restraints",
    curie=BIOSIM_SCHEMA.curie("settings/restraints"),
    model_uri=BIOSIM_SCHEMA.restraints,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.integrator_algorithm = Slot(
    uri=BIOSIM_SCHEMA["settings/integrator_algorithm"],
    name="integrator_algorithm",
    curie=BIOSIM_SCHEMA.curie("settings/integrator_algorithm"),
    model_uri=BIOSIM_SCHEMA.integrator_algorithm,
    domain=None,
    range=Optional[Union[str, "IntegratorAlgorithm"]],
)

slots.barostat_algorithm = Slot(
    uri=BIOSIM_SCHEMA["settings/barostat_algorithm"],
    name="barostat_algorithm",
    curie=BIOSIM_SCHEMA.curie("settings/barostat_algorithm"),
    model_uri=BIOSIM_SCHEMA.barostat_algorithm,
    domain=None,
    range=Optional[Union[str, "BarostatAlgorithm"]],
)

slots.pressure_coupling_type = Slot(
    uri=BIOSIM_SCHEMA["settings/pressure_coupling_type"],
    name="pressure_coupling_type",
    curie=BIOSIM_SCHEMA.curie("settings/pressure_coupling_type"),
    model_uri=BIOSIM_SCHEMA.pressure_coupling_type,
    domain=None,
    range=Optional[Union[str, "PressureCouplingType"]],
)

slots.pressure_coupling_frequency = Slot(
    uri=BIOSIM_SCHEMA["settings/pressure_coupling_frequency"],
    name="pressure_coupling_frequency",
    curie=BIOSIM_SCHEMA.curie("settings/pressure_coupling_frequency"),
    model_uri=BIOSIM_SCHEMA.pressure_coupling_frequency,
    domain=None,
    range=Optional[int],
)

slots.thermostat_algorithm = Slot(
    uri=BIOSIM_SCHEMA["settings/thermostat_algorithm"],
    name="thermostat_algorithm",
    curie=BIOSIM_SCHEMA.curie("settings/thermostat_algorithm"),
    model_uri=BIOSIM_SCHEMA.thermostat_algorithm,
    domain=None,
    range=Optional[Union[str, "ThermostatAlgorithm"]],
)

slots.ensemble_type = Slot(
    uri=BIOSIM_SCHEMA["settings/ensemble_type"],
    name="ensemble_type",
    curie=BIOSIM_SCHEMA.curie("settings/ensemble_type"),
    model_uri=BIOSIM_SCHEMA.ensemble_type,
    domain=None,
    range=Optional[Union[str, "EnsembleType"]],
)

slots.random_seed = Slot(
    uri=BIOSIM_SCHEMA["settings/random_seed"],
    name="random_seed",
    curie=BIOSIM_SCHEMA.curie("settings/random_seed"),
    model_uri=BIOSIM_SCHEMA.random_seed,
    domain=None,
    range=Optional[int],
)

slots.temperature_time_constant = Slot(
    uri=BIOSIM_SCHEMA["settings/temperature_time_constant"],
    name="temperature_time_constant",
    curie=BIOSIM_SCHEMA.curie("settings/temperature_time_constant"),
    model_uri=BIOSIM_SCHEMA.temperature_time_constant,
    domain=None,
    range=Optional[Union[dict, VectorTimeQuantity]],
)

slots.coupling_group = Slot(
    uri=BIOSIM_SCHEMA["settings/coupling_group"],
    name="coupling_group",
    curie=BIOSIM_SCHEMA.curie("settings/coupling_group"),
    model_uri=BIOSIM_SCHEMA.coupling_group,
    domain=None,
    range=Optional[str],
)

slots.chain_length = Slot(
    uri=BIOSIM_SCHEMA["settings/chain_length"],
    name="chain_length",
    curie=BIOSIM_SCHEMA.curie("settings/chain_length"),
    model_uri=BIOSIM_SCHEMA.chain_length,
    domain=None,
    range=Optional[int],
)

slots.friction_coefficient = Slot(
    uri=BIOSIM_SCHEMA["settings/friction_coefficient"],
    name="friction_coefficient",
    curie=BIOSIM_SCHEMA.curie("settings/friction_coefficient"),
    model_uri=BIOSIM_SCHEMA.friction_coefficient,
    domain=None,
    range=Optional[Union[dict, FrictionCoefficientQuantity]],
)

slots.collision_frequency = Slot(
    uri=BIOSIM_SCHEMA["settings/collision_frequency"],
    name="collision_frequency",
    curie=BIOSIM_SCHEMA.curie("settings/collision_frequency"),
    model_uri=BIOSIM_SCHEMA.collision_frequency,
    domain=None,
    range=Optional[Union[dict, FrequencyQuantity]],
)

slots.target_temperature = Slot(
    uri=BIOSIM_SCHEMA["settings/target_temperature"],
    name="target_temperature",
    curie=BIOSIM_SCHEMA.curie("settings/target_temperature"),
    model_uri=BIOSIM_SCHEMA.target_temperature,
    domain=None,
    range=Optional[Union[dict, VectorTemperatureQuantity]],
)

slots.target_pressure = Slot(
    uri=BIOSIM_SCHEMA["settings/target_pressure"],
    name="target_pressure",
    curie=BIOSIM_SCHEMA.curie("settings/target_pressure"),
    model_uri=BIOSIM_SCHEMA.target_pressure,
    domain=None,
    range=Optional[Union[dict, MatrixPressureQuantity]],
)

slots.compressibility = Slot(
    uri=BIOSIM_SCHEMA["settings/compressibility"],
    name="compressibility",
    curie=BIOSIM_SCHEMA.curie("settings/compressibility"),
    model_uri=BIOSIM_SCHEMA.compressibility,
    domain=None,
    range=Optional[Union[dict, MatrixCompressibilityQuantity]],
)

slots.pressure_time_constant = Slot(
    uri=BIOSIM_SCHEMA["settings/pressure_time_constant"],
    name="pressure_time_constant",
    curie=BIOSIM_SCHEMA.curie("settings/pressure_time_constant"),
    model_uri=BIOSIM_SCHEMA.pressure_time_constant,
    domain=None,
    range=Optional[Union[dict, TimeQuantity]],
)

slots.bond_length_constraints_algorithm = Slot(
    uri=BIOSIM_SCHEMA["settings/bond_length_constraints_algorithm"],
    name="bond_length_constraints_algorithm",
    curie=BIOSIM_SCHEMA.curie("settings/bond_length_constraints_algorithm"),
    model_uri=BIOSIM_SCHEMA.bond_length_constraints_algorithm,
    domain=None,
    range=Optional[Union[str, "BondLengthConstraintsAlgorithm"]],
)

slots.electrostatic_cutoff_distance = Slot(
    uri=BIOSIM_SCHEMA["settings/electrostatic_cutoff_distance"],
    name="electrostatic_cutoff_distance",
    curie=BIOSIM_SCHEMA.curie("settings/electrostatic_cutoff_distance"),
    model_uri=BIOSIM_SCHEMA.electrostatic_cutoff_distance,
    domain=None,
    range=Optional[Union[dict, LengthQuantity]],
)

slots.vdw_cutoff_distance = Slot(
    uri=BIOSIM_SCHEMA["settings/vdw_cutoff_distance"],
    name="vdw_cutoff_distance",
    curie=BIOSIM_SCHEMA.curie("settings/vdw_cutoff_distance"),
    model_uri=BIOSIM_SCHEMA.vdw_cutoff_distance,
    domain=None,
    range=Optional[Union[dict, LengthQuantity]],
)

slots.long_range_interaction_method = Slot(
    uri=BIOSIM_SCHEMA["settings/long_range_interaction_method"],
    name="long_range_interaction_method",
    curie=BIOSIM_SCHEMA.curie("settings/long_range_interaction_method"),
    model_uri=BIOSIM_SCHEMA.long_range_interaction_method,
    domain=None,
    range=Optional[Union[str, "LongRangeInteractionMethod"]],
)

slots.salt_concentration = Slot(
    uri=BIOSIM_SCHEMA["composition/salt_concentration"],
    name="salt_concentration",
    curie=BIOSIM_SCHEMA.curie("composition/salt_concentration"),
    model_uri=BIOSIM_SCHEMA.salt_concentration,
    domain=None,
    range=Optional[Union[dict, ConcentrationQuantity]],
)

slots.total_atom_count = Slot(
    uri=BIOSIM_SCHEMA["composition/total_atom_count"],
    name="total_atom_count",
    curie=BIOSIM_SCHEMA.curie("composition/total_atom_count"),
    model_uri=BIOSIM_SCHEMA.total_atom_count,
    domain=None,
    range=Optional[int],
)

slots.total_molecule_count = Slot(
    uri=BIOSIM_SCHEMA["composition/total_molecule_count"],
    name="total_molecule_count",
    curie=BIOSIM_SCHEMA.curie("composition/total_molecule_count"),
    model_uri=BIOSIM_SCHEMA.total_molecule_count,
    domain=None,
    range=Optional[int],
)

slots.atom_count = Slot(
    uri=BIOSIM_SCHEMA["composition/atom_count"],
    name="atom_count",
    curie=BIOSIM_SCHEMA.curie("composition/atom_count"),
    model_uri=BIOSIM_SCHEMA.atom_count,
    domain=None,
    range=Optional[int],
)

slots.molecule_count = Slot(
    uri=BIOSIM_SCHEMA["composition/molecule_count"],
    name="molecule_count",
    curie=BIOSIM_SCHEMA.curie("composition/molecule_count"),
    model_uri=BIOSIM_SCHEMA.molecule_count,
    domain=None,
    range=Optional[int],
)

slots.monomer_count = Slot(
    uri=BIOSIM_SCHEMA["composition/monomer_count"],
    name="monomer_count",
    curie=BIOSIM_SCHEMA.curie("composition/monomer_count"),
    model_uri=BIOSIM_SCHEMA.monomer_count,
    domain=None,
    range=Optional[int],
)

slots.molecular_weight = Slot(
    uri=BIOSIM_SCHEMA["composition/molecular_weight"],
    name="molecular_weight",
    curie=BIOSIM_SCHEMA.curie("composition/molecular_weight"),
    model_uri=BIOSIM_SCHEMA.molecular_weight,
    domain=None,
    range=Optional[Union[dict, MassQuantity]],
)

slots.molecule_charge = Slot(
    uri=BIOSIM_SCHEMA["composition/molecule_charge"],
    name="molecule_charge",
    curie=BIOSIM_SCHEMA.curie("composition/molecule_charge"),
    model_uri=BIOSIM_SCHEMA.molecule_charge,
    domain=None,
    range=Optional[Union[dict, ChargeQuantity]],
    pattern=re.compile(r"^[+-]?\d+(\.\d+)?$"),
)

slots.unique_molecule_count = Slot(
    uri=BIOSIM_SCHEMA["composition/unique_molecule_count"],
    name="unique_molecule_count",
    curie=BIOSIM_SCHEMA.curie("composition/unique_molecule_count"),
    model_uri=BIOSIM_SCHEMA.unique_molecule_count,
    domain=None,
    range=Optional[int],
)

slots.system_counts = Slot(
    uri=BIOSIM_SCHEMA["composition/system_counts"],
    name="system_counts",
    curie=BIOSIM_SCHEMA.curie("composition/system_counts"),
    model_uri=BIOSIM_SCHEMA.system_counts,
    domain=None,
    range=Optional[Union[dict, SystemCounts]],
)

slots.molecule_ID = Slot(
    uri=BIOSIM_SCHEMA["composition/molecule_ID"],
    name="molecule_ID",
    curie=BIOSIM_SCHEMA.curie("composition/molecule_ID"),
    model_uri=BIOSIM_SCHEMA.molecule_ID,
    domain=None,
    range=Optional[Union[Union[dict, MoleculeID], list[Union[dict, MoleculeID]]]],
)
...
slots.identifier = Slot(
    ...
    model_uri=BIOSIM_SCHEMA.identifier,
    domain=None,
    range=Optional[Union[str, URIorCURIE]],
)

slots.PDB_ID = Slot(
    uri=BIOSIM_SCHEMA["composition/PDB_ID"],
    name="PDB_ID",
    curie=BIOSIM_SCHEMA.curie("composition/PDB_ID"),
    model_uri=BIOSIM_SCHEMA.PDB_ID,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^[0-9A-Za-z]{4}$"),
)

slots.UNIPROT_ID = Slot(
    uri=BIOSIM_SCHEMA["composition/UNIPROT_ID"],
    name="UNIPROT_ID",
    curie=BIOSIM_SCHEMA.curie("composition/UNIPROT_ID"),
    model_uri=BIOSIM_SCHEMA.UNIPROT_ID,
    domain=None,
    range=Optional[str],
...
slots.EMDB_ID = Slot(
    uri=BIOSIM_SCHEMA["composition/EMDB_ID"],
    name="EMDB_ID",
    curie=BIOSIM_SCHEMA.curie("composition/EMDB_ID"),
    model_uri=BIOSIM_SCHEMA.EMDB_ID,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^EMD-\d{4,5}$"),
)

slots.alphafold_ID = Slot(
    uri=BIOSIM_SCHEMA["composition/alphafold_ID"],
    name="alphafold_ID",
    curie=BIOSIM_SCHEMA.curie("composition/alphafold_ID"),
    model_uri=BIOSIM_SCHEMA.alphafold_ID,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^AF-[A-Z0-9]+-F1$"),
)

slots.PubChem_CID = Slot(
    uri=BIOSIM_SCHEMA["composition/PubChem_CID"],
    name="PubChem_CID",
    curie=BIOSIM_SCHEMA.curie("composition/PubChem_CID"),
    model_uri=BIOSIM_SCHEMA.PubChem_CID,
    domain=None,
    range=Optional[str],
...
slots.InChIKey = Slot(
    uri=BIOSIM_SCHEMA["composition/InChIKey"],
    name="InChIKey",
    curie=BIOSIM_SCHEMA.curie("composition/InChIKey"),
    model_uri=BIOSIM_SCHEMA.InChIKey,
    domain=None,
    range=Optional[str],
...
slots.SMILES = Slot(
    uri=BIOSIM_SCHEMA["composition/SMILES"],
    name="SMILES",
    curie=BIOSIM_SCHEMA.curie("composition/SMILES"),
    model_uri=BIOSIM_SCHEMA.SMILES,
    domain=None,
    range=Optional[str],
...
slots.InChI = Slot(
    uri=BIOSIM_SCHEMA["composition/InChI"],
    name="InChI",
    curie=BIOSIM_SCHEMA.curie("composition/InChI"),
    model_uri=BIOSIM_SCHEMA.InChI,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^InChI=1S?/[A-Za-z0-9.+\-]+(/[a-z][^/]*)*$"),
)

slots.molecular_formula = Slot(
    uri=BIOSIM_SCHEMA["composition/molecular_formula"],
    name="molecular_formula",
    curie=BIOSIM_SCHEMA.curie("composition/molecular_formula"),
    model_uri=BIOSIM_SCHEMA.molecular_formula,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^([A-Z][a-z]?\d*)+$"),
)

slots.predicted_structure = Slot(
    uri=BIOSIM_SCHEMA["composition/predicted_structure"],
    name="predicted_structure",
    curie=BIOSIM_SCHEMA.curie("composition/predicted_structure"),
    model_uri=BIOSIM_SCHEMA.predicted_structure,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.modified = Slot(
    uri=BIOSIM_SCHEMA["composition/modified"],
    name="modified",
    curie=BIOSIM_SCHEMA.curie("composition/modified"),
    model_uri=BIOSIM_SCHEMA.modified,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.protein_sequence = Slot(
    uri=BIOSIM_SCHEMA["composition/protein_sequence"],
    name="protein_sequence",
    curie=BIOSIM_SCHEMA.curie("composition/protein_sequence"),
    model_uri=BIOSIM_SCHEMA.protein_sequence,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^[ACDEFGHIKLMNPQRSTVWY]+$"),
)

slots.nucleic_sequence = Slot(
    uri=BIOSIM_SCHEMA["composition/nucleic_sequence"],
    name="nucleic_sequence",
    curie=BIOSIM_SCHEMA.curie("composition/nucleic_sequence"),
    model_uri=BIOSIM_SCHEMA.nucleic_sequence,
    domain=None,
    range=Optional[str],
    pattern=re.compile(r"^[ACGTURYSWKMBDHVN]+$"),
)

slots.simulation_averages = Slot(
    uri=BIOSIM_SCHEMA["observables/simulation_averages"],
    name="simulation_averages",
    curie=BIOSIM_SCHEMA.curie("observables/simulation_averages"),
    model_uri=BIOSIM_SCHEMA.simulation_averages,
    domain=None,
    range=Optional[Union[dict, SimulationAverages]],
)

slots.average_temperature = Slot(
    uri=BIOSIM_SCHEMA["observables/average_temperature"],
    name="average_temperature",
    curie=BIOSIM_SCHEMA.curie("observables/average_temperature"),
    model_uri=BIOSIM_SCHEMA.average_temperature,
    domain=None,
    range=Optional[Union[dict, TemperatureQuantity]],
)

slots.average_pressure = Slot(
    uri=BIOSIM_SCHEMA["observables/average_pressure"],
    name="average_pressure",
    curie=BIOSIM_SCHEMA.curie("observables/average_pressure"),
    model_uri=BIOSIM_SCHEMA.average_pressure,
    domain=None,
    range=Optional[Union[dict, PressureQuantity]],
)

slots.average_volume = Slot(
    uri=BIOSIM_SCHEMA["observables/average_volume"],
    name="average_volume",
    curie=BIOSIM_SCHEMA.curie("observables/average_volume"),
    model_uri=BIOSIM_SCHEMA.average_volume,
    domain=None,
    range=Optional[Union[dict, VolumeQuantity]],
)

slots.average_volume_vector = Slot(
    uri=BIOSIM_SCHEMA["observables/average_volume_vector"],
    name="average_volume_vector",
    curie=BIOSIM_SCHEMA.curie("observables/average_volume_vector"),
    model_uri=BIOSIM_SCHEMA.average_volume_vector,
    domain=None,
    range=Optional[Union[dict, VectorVolumeQuantity]],
)

slots.average_potential_energy = Slot(
    uri=BIOSIM_SCHEMA["observables/average_potential_energy"],
    name="average_potential_energy",
    curie=BIOSIM_SCHEMA.curie("observables/average_potential_energy"),
    model_uri=BIOSIM_SCHEMA.average_potential_energy,
    domain=None,
    range=Optional[Union[dict, MolarEnergyQuantity]],
)

slots.average_kinetic_energy = Slot(
    uri=BIOSIM_SCHEMA["observables/average_kinetic_energy"],
    name="average_kinetic_energy",
    curie=BIOSIM_SCHEMA.curie("observables/average_kinetic_energy"),
    model_uri=BIOSIM_SCHEMA.average_kinetic_energy,
    domain=None,
    range=Optional[Union[dict, MolarEnergyQuantity]],
)

slots.average_enthalpy = Slot(
    uri=BIOSIM_SCHEMA["observables/average_enthalpy"],
    name="average_enthalpy",
    curie=BIOSIM_SCHEMA.curie("observables/average_enthalpy"),
    model_uri=BIOSIM_SCHEMA.average_enthalpy,
    domain=None,
    range=Optional[Union[dict, MolarEnergyQuantity]],
)

slots.connectivity = Slot(
    uri=BIOSIM_SCHEMA["topology/connectivity"],
    name="connectivity",
    curie=BIOSIM_SCHEMA.curie("topology/connectivity"),
    model_uri=BIOSIM_SCHEMA.connectivity,
    domain=None,
    range=Optional[Union[dict, Connectivity]],
)

slots.particles = Slot(
    uri=BIOSIM_SCHEMA["topology/particles"],
    name="particles",
    curie=BIOSIM_SCHEMA.curie("topology/particles"),
    model_uri=BIOSIM_SCHEMA.particles,
    domain=None,
    range=Optional[Union[dict, Particles]],
)

slots.masses = Slot(
    uri=BIOSIM_SCHEMA["topology/masses"],
    name="masses",
    curie=BIOSIM_SCHEMA.curie("topology/masses"),
    model_uri=BIOSIM_SCHEMA.masses,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.bonds = Slot(
    uri=BIOSIM_SCHEMA["topology/bonds"],
    name="bonds",
    curie=BIOSIM_SCHEMA.curie("topology/bonds"),
    model_uri=BIOSIM_SCHEMA.bonds,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.dihedrals = Slot(
    uri=BIOSIM_SCHEMA["topology/dihedrals"],
    name="dihedrals",
    curie=BIOSIM_SCHEMA.curie("topology/dihedrals"),
    model_uri=BIOSIM_SCHEMA.dihedrals,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.fixed_charges = Slot(
    uri=BIOSIM_SCHEMA["topology/fixed_charges"],
    name="fixed_charges",
    curie=BIOSIM_SCHEMA.curie("topology/fixed_charges"),
    model_uri=BIOSIM_SCHEMA.fixed_charges,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.coarse_grained = Slot(
    uri=BIOSIM_SCHEMA["topology/coarse_grained"],
    name="coarse_grained",
    curie=BIOSIM_SCHEMA.curie("topology/coarse_grained"),
    model_uri=BIOSIM_SCHEMA.coarse_grained,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.system_charge = Slot(
    uri=BIOSIM_SCHEMA["topology/system_charge"],
    name="system_charge",
    curie=BIOSIM_SCHEMA.curie("topology/system_charge"),
    model_uri=BIOSIM_SCHEMA.system_charge,
    domain=None,
    range=Optional[Union[dict, ChargeQuantity]],
    pattern=re.compile(r"^[+-]?\d+(\.\d+)?$"),
)

slots.resolution = Slot(
    uri=BIOSIM_SCHEMA["topology/resolution"],
    name="resolution",
    curie=BIOSIM_SCHEMA.curie("topology/resolution"),
    model_uri=BIOSIM_SCHEMA.resolution,
    domain=None,
    range=Optional[Union[str, "ModelResolution"]],
)

slots.simulation_box = Slot(
    uri=BIOSIM_SCHEMA["trajectory/simulation_box"],
    name="simulation_box",
    curie=BIOSIM_SCHEMA.curie("trajectory/simulation_box"),
    model_uri=BIOSIM_SCHEMA.simulation_box,
    domain=None,
    range=Optional[Union[dict, SimulationBox]],
)

slots.trajectory_output = Slot(
    uri=BIOSIM_SCHEMA["trajectory/trajectory_output"],
    name="trajectory_output",
    curie=BIOSIM_SCHEMA.curie("trajectory/trajectory_output"),
    model_uri=BIOSIM_SCHEMA.trajectory_output,
    domain=None,
    range=Optional[Union[dict, Trajectories]],
)

slots.frame_count = Slot(
    uri=BIOSIM_SCHEMA["trajectory/frame_count"],
    name="frame_count",
    curie=BIOSIM_SCHEMA.curie("trajectory/frame_count"),
    model_uri=BIOSIM_SCHEMA.frame_count,
    domain=None,
    range=Optional[int],
)

slots.periodic_boundary_conditions = Slot(
    uri=BIOSIM_SCHEMA["trajectory/periodic_boundary_conditions"],
    name="periodic_boundary_conditions",
    curie=BIOSIM_SCHEMA.curie("trajectory/periodic_boundary_conditions"),
    model_uri=BIOSIM_SCHEMA.periodic_boundary_conditions,
    domain=None,
    range=Optional[Union[str, "PeriodicBoundaryConditions"]],
)

slots.box_dimensions = Slot(
    uri=BIOSIM_SCHEMA["trajectory/box_dimensions"],
    name="box_dimensions",
    curie=BIOSIM_SCHEMA.curie("trajectory/box_dimensions"),
    model_uri=BIOSIM_SCHEMA.box_dimensions,
    domain=None,
    range=Optional[Union[dict, VectorLengthQuantity]],
)

slots.box_angles = Slot(
    uri=BIOSIM_SCHEMA["trajectory/box_angles"],
    name="box_angles",
    curie=BIOSIM_SCHEMA.curie("trajectory/box_angles"),
    model_uri=BIOSIM_SCHEMA.box_angles,
    domain=None,
    range=Optional[Union[dict, VectorAngleQuantity]],
)

slots.box_type = Slot(
    uri=BIOSIM_SCHEMA["trajectory/box_type"],
    name="box_type",
    curie=BIOSIM_SCHEMA.curie("trajectory/box_type"),
    model_uri=BIOSIM_SCHEMA.box_type,
    domain=None,
    range=Optional[Union[str, "BoxType"]],
)

slots.positions = Slot(
    uri=BIOSIM_SCHEMA["trajectory/positions"],
    name="positions",
    curie=BIOSIM_SCHEMA.curie("trajectory/positions"),
    model_uri=BIOSIM_SCHEMA.positions,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.forces = Slot(
    uri=BIOSIM_SCHEMA["trajectory/forces"],
    name="forces",
    curie=BIOSIM_SCHEMA.curie("trajectory/forces"),
    model_uri=BIOSIM_SCHEMA.forces,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.velocities = Slot(
    uri=BIOSIM_SCHEMA["trajectory/velocities"],
    name="velocities",
    curie=BIOSIM_SCHEMA.curie("trajectory/velocities"),
    model_uri=BIOSIM_SCHEMA.velocities,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.energies = Slot(
    uri=BIOSIM_SCHEMA["trajectory/energies"],
    name="energies",
    curie=BIOSIM_SCHEMA.curie("trajectory/energies"),
    model_uri=BIOSIM_SCHEMA.energies,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.polarizable_charges = Slot(
    uri=BIOSIM_SCHEMA["trajectory/polarizable_charges"],
    name="polarizable_charges",
    curie=BIOSIM_SCHEMA.curie("trajectory/polarizable_charges"),
    model_uri=BIOSIM_SCHEMA.polarizable_charges,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.water = Slot(
    uri=BIOSIM_SCHEMA["trajectory/water"],
    name="water",
    curie=BIOSIM_SCHEMA.curie("trajectory/water"),
    model_uri=BIOSIM_SCHEMA.water,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.replica = Slot(
    uri=BIOSIM_SCHEMA["trajectory/replica"],
    name="replica",
    curie=BIOSIM_SCHEMA.curie("trajectory/replica"),
    model_uri=BIOSIM_SCHEMA.replica,
    domain=None,
    range=Optional[Union[bool, Bool]],
)

slots.water_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/water_potential"],
    name="water_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/water_potential"),
    model_uri=BIOSIM_SCHEMA.water_potential,
    domain=None,
    range=Optional[Union[dict, WaterPotential]],
)

slots.water_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/water_potential_name"],
    name="water_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/water_potential_name"),
    model_uri=BIOSIM_SCHEMA.water_potential_name,
    domain=None,
    range=Optional[Union[str, "WaterPotentialName"]],
)

slots.protein_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/protein_potential"],
    name="protein_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/protein_potential"),
    model_uri=BIOSIM_SCHEMA.protein_potential,
    domain=None,
    range=Optional[Union[dict, ProteinPotential]],
)

slots.protein_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/protein_potential_name"],
    name="protein_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/protein_potential_name"),
    model_uri=BIOSIM_SCHEMA.protein_potential_name,
    domain=None,
    range=Optional[Union[str, "ProteinPotentialName"]],
)

slots.lipid_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/lipid_potential"],
    name="lipid_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/lipid_potential"),
    model_uri=BIOSIM_SCHEMA.lipid_potential,
    domain=None,
    range=Optional[Union[dict, LipidPotential]],
)

slots.lipid_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/lipid_potential_name"],
    name="lipid_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/lipid_potential_name"),
    model_uri=BIOSIM_SCHEMA.lipid_potential_name,
    domain=None,
    range=Optional[Union[str, "LipidPotentialName"]],
)

slots.nucleic_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/nucleic_potential"],
    name="nucleic_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/nucleic_potential"),
    model_uri=BIOSIM_SCHEMA.nucleic_potential,
    domain=None,
    range=Optional[Union[dict, NucleicPotential]],
)

slots.nucleic_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/nucleic_potential_name"],
    name="nucleic_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/nucleic_potential_name"),
    model_uri=BIOSIM_SCHEMA.nucleic_potential_name,
    domain=None,
    range=Optional[Union[str, "NucleicPotentialName"]],
)

slots.carbohydrate_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/carbohydrate_potential"],
    name="carbohydrate_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/carbohydrate_potential"),
    model_uri=BIOSIM_SCHEMA.carbohydrate_potential,
    domain=None,
    range=Optional[Union[dict, CarbohydratePotential]],
)

slots.carbohydrate_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/carbohydrate_potential_name"],
    name="carbohydrate_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/carbohydrate_potential_name"),
    model_uri=BIOSIM_SCHEMA.carbohydrate_potential_name,
    domain=None,
    range=Optional[Union[str, "CarbohydratePotentialName"]],
)

slots.polymer_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/polymer_potential"],
    name="polymer_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/polymer_potential"),
    model_uri=BIOSIM_SCHEMA.polymer_potential,
    domain=None,
    range=Optional[Union[dict, PolymerPotential]],
)

slots.polymer_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/polymer_potential_name"],
    name="polymer_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/polymer_potential_name"),
    model_uri=BIOSIM_SCHEMA.polymer_potential_name,
    domain=None,
    range=Optional[Union[str, "PolymerPotentialName"]],
)

slots.general_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/general_potential"],
    name="general_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/general_potential"),
    model_uri=BIOSIM_SCHEMA.general_potential,
    domain=None,
    range=Optional[Union[dict, GeneralPotential]],
)

slots.general_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/general_potential_name"],
    name="general_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/general_potential_name"),
    model_uri=BIOSIM_SCHEMA.general_potential_name,
    domain=None,
    range=Optional[Union[str, "GeneralPotentialName"]],
)

slots.machine_learned_potential = Slot(
    uri=BIOSIM_SCHEMA["potentials/machine_learned_potential"],
    name="machine_learned_potential",
    curie=BIOSIM_SCHEMA.curie("potentials/machine_learned_potential"),
    model_uri=BIOSIM_SCHEMA.machine_learned_potential,
    domain=None,
    range=Optional[Union[dict, MachineLearnedPotential]],
)

slots.machine_learned_potential_name = Slot(
    uri=BIOSIM_SCHEMA["potentials/machine_learned_potential_name"],
    name="machine_learned_potential_name",
    curie=BIOSIM_SCHEMA.curie("potentials/machine_learned_potential_name"),
    model_uri=BIOSIM_SCHEMA.machine_learned_potential_name,
    domain=None,
    range=Optional[Union[str, "MachineLearnedPotentialName"]],
)

slots.hardware = Slot(
    uri=BIOSIM_SCHEMA["compute/hardware"],
    name="hardware",
    curie=BIOSIM_SCHEMA.curie("compute/hardware"),
    model_uri=BIOSIM_SCHEMA.hardware,
    domain=None,
    range=Optional[Union[dict, Hardware]],
)

slots.software = Slot(
    uri=BIOSIM_SCHEMA["compute/software"],
    name="software",
    curie=BIOSIM_SCHEMA.curie("compute/software"),
    model_uri=BIOSIM_SCHEMA.software,
    domain=None,
    range=Optional[Union[dict, Software]],
)

slots.performance = Slot(
    uri=BIOSIM_SCHEMA["compute/performance"],
    name="performance",
    curie=BIOSIM_SCHEMA.curie("compute/performance"),
    model_uri=BIOSIM_SCHEMA.performance,
    domain=None,
    range=Optional[Union[dict, Performance]],
)

slots.operating_system = Slot(
    uri=BIOSIM_SCHEMA["compute/operating_system"],
    name="operating_system",
    curie=BIOSIM_SCHEMA.curie("compute/operating_system"),
    model_uri=BIOSIM_SCHEMA.operating_system,
    domain=None,
    range=Optional[Union[str, "OperatingSystem"]],
)

slots.scheduler = Slot(
    uri=BIOSIM_SCHEMA["compute/scheduler"],
    name="scheduler",
    curie=BIOSIM_SCHEMA.curie("compute/scheduler"),
    model_uri=BIOSIM_SCHEMA.scheduler,
    domain=None,
    range=Optional[Union[str, "Scheduler"]],
)

slots.MPI_library = Slot(
    uri=BIOSIM_SCHEMA["compute/MPI_library"],
    name="MPI_library",
    curie=BIOSIM_SCHEMA.curie("compute/MPI_library"),
    model_uri=BIOSIM_SCHEMA.MPI_library,
    domain=None,
    range=Optional[Union[str, "MPILibrary"]],
)

slots.container_runtime = Slot(
    uri=BIOSIM_SCHEMA["compute/container_runtime"],
    name="container_runtime",
    curie=BIOSIM_SCHEMA.curie("compute/container_runtime"),
    model_uri=BIOSIM_SCHEMA.container_runtime,
    domain=None,
    range=Optional[Union[str, "ContainerRuntime"]],
)

slots.wall_time = Slot(
    uri=BIOSIM_SCHEMA["compute/wall_time"],
    name="wall_time",
    curie=BIOSIM_SCHEMA.curie("compute/wall_time"),
    model_uri=BIOSIM_SCHEMA.wall_time,
    domain=None,
    range=Optional[Union[dict, TimeQuantity]],
)

slots.energy_consumption = Slot(
    uri=BIOSIM_SCHEMA["compute/energy_consumption"],
    name="energy_consumption",
    curie=BIOSIM_SCHEMA.curie("compute/energy_consumption"),
    model_uri=BIOSIM_SCHEMA.energy_consumption,
    domain=None,
    range=Optional[Union[dict, EnergyQuantity]],
)

slots.execution_platform = Slot(
    uri=BIOSIM_SCHEMA["compute/execution_platform"],
    name="execution_platform",
    curie=BIOSIM_SCHEMA.curie("compute/execution_platform"),
    model_uri=BIOSIM_SCHEMA.execution_platform,
    domain=None,
    range=Optional[Union[str, "ExecutionPlatform"]],
)

slots.node_type = Slot(
    uri=BIOSIM_SCHEMA["compute/node_type"],
    name="node_type",
    curie=BIOSIM_SCHEMA.curie("compute/node_type"),
    model_uri=BIOSIM_SCHEMA.node_type,
    domain=None,
    range=Optional[Union[str, "NodeType"]],
)

slots.node_count = Slot(
    uri=BIOSIM_SCHEMA["compute/node_count"],
    name="node_count",
    curie=BIOSIM_SCHEMA.curie("compute/node_count"),
    model_uri=BIOSIM_SCHEMA.node_count,
    domain=None,
    range=Optional[int],
)

slots.CPU_vendor = Slot(
    uri=BIOSIM_SCHEMA["compute/CPU_vendor"],
    name="CPU_vendor",
    curie=BIOSIM_SCHEMA.curie("compute/CPU_vendor"),
    model_uri=BIOSIM_SCHEMA.CPU_vendor,
    domain=None,
    range=Optional[Union[str, "CpuVendor"]],
)

slots.CPU_architecture = Slot(
    uri=BIOSIM_SCHEMA["compute/CPU_architecture"],
    name="CPU_architecture",
    curie=BIOSIM_SCHEMA.curie("compute/CPU_architecture"),
    model_uri=BIOSIM_SCHEMA.CPU_architecture,
    domain=None,
    range=Optional[Union[str, "CpuArchitecture"]],
)

slots.sockets_per_node = Slot(
    uri=BIOSIM_SCHEMA["compute/sockets_per_node"],
    name="sockets_per_node",
    curie=BIOSIM_SCHEMA.curie("compute/sockets_per_node"),
    model_uri=BIOSIM_SCHEMA.sockets_per_node,
    domain=None,
    range=Optional[int],
)

slots.cores_per_socket = Slot(
    uri=BIOSIM_SCHEMA["compute/cores_per_socket"],
    name="cores_per_socket",
    curie=BIOSIM_SCHEMA.curie("compute/cores_per_socket"),
    model_uri=BIOSIM_SCHEMA.cores_per_socket,
    domain=None,
    range=Optional[int],
)

slots.threads_per_core = Slot(
    uri=BIOSIM_SCHEMA["compute/threads_per_core"],
    name="threads_per_core",
    curie=BIOSIM_SCHEMA.curie("compute/threads_per_core"),
    model_uri=BIOSIM_SCHEMA.threads_per_core,
    domain=None,
    range=Optional[int],
)

slots.GPU_vendor = Slot(
    uri=BIOSIM_SCHEMA["compute/GPU_vendor"],
    name="GPU_vendor",
    curie=BIOSIM_SCHEMA.curie("compute/GPU_vendor"),
    model_uri=BIOSIM_SCHEMA.GPU_vendor,
    domain=None,
    range=Optional[Union[str, "GpuVendor"]],
)

slots.GPUs_per_node = Slot(
    uri=BIOSIM_SCHEMA["compute/GPUs_per_node"],
    name="GPUs_per_node",
    curie=BIOSIM_SCHEMA.curie("compute/GPUs_per_node"),
    model_uri=BIOSIM_SCHEMA.GPUs_per_node,
    domain=None,
    range=Optional[int],
)

slots.memory_per_node = Slot(
    uri=BIOSIM_SCHEMA["compute/memory_per_node"],
    name="memory_per_node",
    curie=BIOSIM_SCHEMA.curie("compute/memory_per_node"),
    model_uri=BIOSIM_SCHEMA.memory_per_node,
    domain=None,
    range=Optional[Union[dict, ByteQuantity]],
)

slots.lengthQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="lengthQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.lengthQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.lengthQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="lengthQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.lengthQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "LengthUnit"]],
)

slots.volumeQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="volumeQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.volumeQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.volumeQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="volumeQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.volumeQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "VolumeUnit"]],
)

slots.timeQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="timeQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.timeQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.timeQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="timeQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.timeQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "TimeUnit"]],
)

slots.frequencyQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="frequencyQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.frequencyQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.frequencyQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="frequencyQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.frequencyQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "FrequencyUnit"]],
)

slots.frictionCoefficientQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="frictionCoefficientQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.frictionCoefficientQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.frictionCoefficientQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="frictionCoefficientQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.frictionCoefficientQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "FrictionCoefficientUnit"]],
)

slots.molarEnergyQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="molarEnergyQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.molarEnergyQuantity__value,
    domain=None,
    range=Optional[float],
    pattern=re.compile(r"^[+-]?\d+(\.\d+)?$"),
)

slots.molarEnergyQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="molarEnergyQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.molarEnergyQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "MolarEnergyUnit"]],
)

slots.energyQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="energyQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.energyQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.energyQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="energyQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.energyQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "EnergyUnit"]],
)

slots.temperatureQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="temperatureQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.temperatureQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.temperatureQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="temperatureQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.temperatureQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "TemperatureUnit"]],
)

slots.pressureQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="pressureQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.pressureQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.pressureQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="pressureQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.pressureQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "PressureUnit"]],
)

slots.massQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="massQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.massQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.massQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="massQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.massQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "MassUnit"]],
)

slots.concentrationQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="concentrationQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.concentrationQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.concentrationQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="concentrationQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.concentrationQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "ConcentrationUnit"]],
)

slots.forceQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="forceQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.forceQuantity__value,
    domain=None,
    range=Optional[float],
    pattern=re.compile(r"^[+-]?\d+(\.\d+)?$"),
)

slots.forceQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="forceQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.forceQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "ForceUnit"]],
)

slots.chargeQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="chargeQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.chargeQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.chargeQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="chargeQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.chargeQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "ChargeUnit"]],
)

slots.angleQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="angleQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.angleQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.angleQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="angleQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.angleQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "AngleUnit"]],
)

slots.byteQuantity__value = Slot(
    uri=BIOSIM_SCHEMA["quantities/value"],
    name="byteQuantity__value",
    curie=BIOSIM_SCHEMA.curie("quantities/value"),
    model_uri=BIOSIM_SCHEMA.byteQuantity__value,
    domain=None,
    range=Optional[float],
)

slots.byteQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="byteQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.byteQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "ByteUnit"]],
)

slots.vectorLengthQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorLengthQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorLengthQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorLengthQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorLengthQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorLengthQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "LengthUnit"]],
)

slots.vectorAngleQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorAngleQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorAngleQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorAngleQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorAngleQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorAngleQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "AngleUnit"]],
)

slots.vectorVolumeQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorVolumeQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorVolumeQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorVolumeQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorVolumeQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorVolumeQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "LengthUnit"]],
)

slots.vectorCompressibilityQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorCompressibilityQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorCompressibilityQuantity__vector_value,
    domain=None,
    range=Optional[float],
)

slots.vectorCompressibilityQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorCompressibilityQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorCompressibilityQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "CompressibilityUnit"]],
)

slots.vectorPressureQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorPressureQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorPressureQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorPressureQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorPressureQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorPressureQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "PressureUnit"]],
)

slots.vectorTemperatureQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorTemperatureQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorTemperatureQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorTemperatureQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorTemperatureQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorTemperatureQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "TemperatureUnit"]],
)

slots.vectorTimeQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="vectorTimeQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.vectorTimeQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.vectorTimeQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="vectorTimeQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.vectorTimeQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "TimeUnit"]],
)

slots.matrixPressureQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="matrixPressureQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.matrixPressureQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.matrixPressureQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="matrixPressureQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.matrixPressureQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "PressureUnit"]],
)

slots.matrixCompressibilityQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="matrixCompressibilityQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.matrixCompressibilityQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.matrixCompressibilityQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="matrixCompressibilityQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.matrixCompressibilityQuantity__value_unit,
    domain=None,
    range=Optional[Union[str, "CompressibilityUnit"]],
)

slots.matrixQuantity__vector_value = Slot(
    uri=BIOSIM_SCHEMA["quantities/vector_value"],
    name="matrixQuantity__vector_value",
    curie=BIOSIM_SCHEMA.curie("quantities/vector_value"),
    model_uri=BIOSIM_SCHEMA.matrixQuantity__vector_value,
    domain=None,
    range=Optional[Union[float, list[float]]],
)

slots.matrixQuantity__value_unit = Slot(
    uri=BIOSIM_SCHEMA["quantities/value_unit"],
    name="matrixQuantity__value_unit",
    curie=BIOSIM_SCHEMA.curie("quantities/value_unit"),
    model_uri=BIOSIM_SCHEMA.matrixQuantity__value_unit,
    domain=None,
    range=Optional[str],
)
